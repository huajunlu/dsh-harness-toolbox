...
async function balanceSection(ctx, home, { fresh }) {
  ...
  if (live.live && live.balances && live.balances.length > 0) {
    return { balances: live.balances, balanceSource: 'live', balanceNote: null, accountLinks: live.links ?? null, spend: null }
  }
  if (live.live && live.signedOut) {
    return { balances: [], balanceSource: 'live-signed-out', balanceNote: 'signed-out', accountLinks: live.links ?? null, spend: null }
  }
